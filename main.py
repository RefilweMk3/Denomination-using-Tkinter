...
root = Tk()
root.title('Denomination Amount counter')
...
label1 = Label(root, text = "Hey user!! Welcome to the Denomination Counter App", bg = "light blue")
...
def topwin():
    ...
    entry = Entry(top)
    lbl = Label(top, text="Here are the number of notees for each denomination", bg="light grey")
